  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <Text style={styles.title}>Ongoing - Seedling Stage</Text>
        ...
        <View style={styles.weekContainer}>
          ...
          <TouchableOpacity style={styles.readMoreButton} onPress={()=>navigation.navigate(ScreensName.BasalFertilization)}>
        ...
        <View style={styles.weekContainer}>
          <View style={styles.weekHeader}>
            ...
            <TouchableOpacity style={styles.plantingButton}>
              <Text style={styles.plantingText}>Planting</Text>
            </TouchableOpacity>
          </View>
