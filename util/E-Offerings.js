import EBroker from "../src/screens/MainApp/TabScreens/E-Broker/E-Broker";
...
const allNames = [
  ...
  { name: "E-Broker", screen: ScreensName.EBrokerMainStack ,source: require("../src/assets/MainApp/HomeScreen/munshi.png"),},
