    ...
    return (
        <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: hp(1), flex: 0.3 }}>
                <Text style={{ fontWeight: '800', fontSize: hp(2), color: colors.BLACK }}>Holdings</Text>
            </View>
            <View style={{ flex: 0.6, flexDirection: 'row' }}>
                ...
                <View style={{ flex: 0.6 }}>
                    ...
                    <View style={{ flexDirection: 'row', flex: 0.4 }}>
                        <View style={{ flex: 0.7 }}>
                            ...
                            <Text style={{fontWeight:'bold'}}>Shr Holding:</Text>
                        </View>
                        <View style={{ flex: 0.4 }}>
                ...
                <View style={{ flex: 0.8, flexDirection: 'row', gap: hp(1), justifyContent: 'center', alignItems: 'center' }}>
                    <CustomButton MainText={'Buy'} hgiven={hp(5)} wgiven={wp(20)} b_radius={hp(0.3)} BgGiven={colors.GREEN} txColor={colors.WHITE} onPressG={() => setIsExpanded((prev) => !prev)} />
                    <CustomButton MainText={'Sell'} hgiven={hp(5)} wgiven={wp(20)} b_radius={hp(0.3)} BgGiven={colors.RED} bordergiven={colors.RED} txColor={colors.WHITE} onPressG={() => setIsExpanded((prev) => !prev)} />
