                        ...
                        {ETransportMaindet.map((Category, index) => (
                            Category.title.trim() !== '' && (
                                <View style={styles.itemBoxWrapper} key={index}>
                                    <EInventoryBoxes name={t(Category.title)} screenName={Category.screen} navigationName={ScreensName.ETransportStack} SourceGiven={Category.img} isNavigation={1} w={wp('85%')} h={hp('18%')} />
                                </View>
                            )
                        ))}
                    </View>
