      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.itemDetailsContainer}>
          <View style={styles.detailsContainer}>
            <View style={styles.detailRow}>
              <Text style={styles.labelText}>{t("E-Broker")}</Text>
            </View>
        ...
        <View style={{ flex: 1, flexDirection: 'column', marginTop: hp(3) }}>
          ...
          <View style={{ margin:hp(1.5), flex: 0.5,gap:hp(1.2),flexDirection:'row',flexWrap:'wrap' }}>
            <BrokerComponent broker={"Arif Habib Limited"} specialty={"Rice"} location={"Karachi"} phone={"924144141"} email={"abcbroker@gmail.com"} website={"www.abcbroker.com"} />
            <BrokerComponent broker={"Arif Habib Limited"} specialty={"Rice"} location={"Karachi"} phone={"924144141"} email={"abcbroker@gmail.com"} website={"www.abcbroker.com"} />
            <BrokerComponent broker={"Arif Habib Limited"} specialty={"Rice"} location={"Karachi"} phone={"924144141"} email={"abcbroker@gmail.com"} website={"www.abcbroker.com"} />
            <BrokerComponent broker={"Arif Habib Limited"} specialty={"Rice"} location={"Karachi"} phone={"924144141"} email={"abcbroker@gmail.com"} website={"www.abcbroker.com"} />
            <BrokerComponent broker={"Arif Habib Limited"} specialty={"Rice"} location={"Karachi"} phone={"924144141"} email={"abcbroker@gmail.com"} website={"www.abcbroker.com"} />
